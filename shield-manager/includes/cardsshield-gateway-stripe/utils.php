...
defined('MetaKey_Stripe_Proxy_Url') || define('MetaKey_Stripe_Proxy_Url', '_WOOTIFY_stripe_proxy_url');
...
defined('METAKEY_WOOTIFY_STRIPE_INTENT_AUTHORIZED') || define('METAKEY_WOOTIFY_STRIPE_INTENT_AUTHORIZED', '_METAKEY_WOOTIFY_STRIPE_INTENT_CAPTURED');
defined('METAKEY_STRIPE_PROXY_URL') || define('METAKEY_STRIPE_PROXY_URL', '_WOOTIFY_stripe_proxy_url');
defined('METAKEY_STRIPE_PROXY_ID') || define('METAKEY_STRIPE_PROXY_ID', '_WOOTIFY_stripe_proxy_id');
defined('WOOTIFY_STRIPE_BY_TIME') || define('WOOTIFY_STRIPE_BY_TIME', 'by_time');
defined('WOOTIFY_STRIPE_BY_AMOUNT') || define('WOOTIFY_STRIPE_BY_AMOUNT', 'by_amount');
